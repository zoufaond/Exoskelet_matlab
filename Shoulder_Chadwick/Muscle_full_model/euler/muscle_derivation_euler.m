...
if genEq==1
    ...
    %
    matlabFunction(mus_force,'file','euler/mus_forces_full_ulna_eul','vars',{t,q,act,fmax,lceopt,lslack});
    % matlabFunction(mus_len,'file','euler/mus_lengths_simp_ulna','vars',{t,q});
    matlabFunction(f_muscles,'file','euler/TE_muscles_full_ulna_eul','vars',{t,q,act,fmax,lceopt,lslack});
end
