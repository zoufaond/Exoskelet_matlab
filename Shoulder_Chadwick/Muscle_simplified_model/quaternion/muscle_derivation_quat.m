...
% this is for symbolical creation of muscle forces
...
% polynomials are functions of imaginary part of quaternions
...
if genEq == 1
    ...
    % mapping from quaternion space to external moments
    ...
    matlabFunction(TE_muscles,'file','quaternion/TE_simplified_quat','vars',{t,q,act,fmax,lceopt,lslack});
    matlabFunction(mus_force,'file','quaternion/mus_forces_simplified_quat','vars',{t,q,act,fmax,lceopt,lslack});
