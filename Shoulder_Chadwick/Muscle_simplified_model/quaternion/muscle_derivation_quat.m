...
if genEq == 1
    ...
    matlabFunction(TE_muscles,'file','quaternion/TE_muscles_simp_ulna','vars',{t,q,act,fmax,lceopt,lslack});
    matlabFunction(mus_force,'file','quaternion/mus_forces_simp_ulna_quat','vars',{t,q,act,fmax,lceopt,lslack});
